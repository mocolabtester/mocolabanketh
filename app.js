...
let sessionData = {
    ...
    siralama: 1, // 1: Destekleyici -> Karşıt, 2: Karşıt -> Destekleyici
...
function initAppNavigation() {
    ...
    btnD1InitNext.addEventListener("click", () => {
        ...
        // UYALAMALI ATAMA MANTIĞI (DESTEKLEYİCİ İLK):
        // 1: Evet (İsrafı önle -> unfrnsh), 2: Hayır (Eşitliği koru -> wstflh)
    ...
    btnD2InitNext.addEventListener("click", () => {
        ...
        // KARŞIT İNSAN (Katılımcının İkilem 2'deki kararına kesinlikle KARŞIT model atanır):
